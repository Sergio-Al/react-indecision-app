...
var IndecisionApp = function (_React$Component) {
  ...
  _createClass(IndecisionApp, [{
    ...
    key: "componenWilUnmount",
    value: function componenWilUnmount() {
...
ReactDOM.render(React.createElement(IndecisionApp, { options: ["Option dfs", "Second District"] }), document.getElementById("app"));
